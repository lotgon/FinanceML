...
mean_belowMA200 <- d[diffM200<0.9, mean(profit_5y, na.rm=TRUE)]
#AB testing to be sure that means are different
t.test(d[diffM200<0.9, profit_5y], d[,profit_5y])
#just for research
...
ggplot() + 
  ...
  geom_density(data = d[diffM200<0.9], aes(x = profit_5y, fill = "b"), alpha = 0.3) +
  scale_colour_manual(name ="Comparison", values = c("r" = "red", "b" = "blue"), labels=c("b" = "Price < 0.9*MA200", "r" = "Random buying")) +
  scale_fill_manual(name ="Comparison", values = c("r" = "red", "b" = "blue"), labels=c("b" = "Price < 0.9*MA200", "r" = "Random buying")) +
