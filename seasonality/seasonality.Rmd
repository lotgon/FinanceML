...
ggplot() + geom_line(data=cTable, aes(x=day, y=value, group=clusterIndex, color=clusterIndex, size=clusterPower)) + geom_hline(yintercept = 1, color="red") + geom_line(data=curr_year, aes(x=day, y=mva), color="red")
```
